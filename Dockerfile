FROM ubuntu:20.04
RUN apt update
RUN apt install qemu-kvm xz-utils dbus-x11 curl gnome-system-monitor mate-system-monitor  git xfce4 xfce4-terminal tightvncserver wget net-tools  build-essential vim  -y
